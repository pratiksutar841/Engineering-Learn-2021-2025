/* 1] Singly LinkedList (SLL) of Integer Data
    a] Create a SLL stack of N Integer
    b] Display of SLL
    c] linear search. Create a SLL queue of N Student Data Concatenation of two SLL  of Integer*/
...
void create() 
          ...
          printf("\n Enter usn,name, branch, sem, phone no. of student : "); 
