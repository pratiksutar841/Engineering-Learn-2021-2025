...
import java.io.*;
import java.util.*;
public class ClassifyTheNumber{ 
...
/*
 *Approach:
 • In this question we have simply taken the 2D matrix as input from the user and traversed the matrix and
 checked for every element whether it is positive, negative, zero, odd or even.
 • We have used if conditions and not if-else because one element of the matrix can play multiple roles. It can be
 even as well as positive and there are similar other possibilities as well.
